        ...
        <>
            ...
            <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 2rem 5rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "3rem" }}>
                    {openRoles.map((role, i) => (
                        <div key={i} style={{
                            ...
                            <a href="mailto:careers@sancodevs.com" style={{
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: "13px", fontWeight: 500, color: "var(--text)", marginBottom: "6px" }}>Don&apos;t see your role?</p>
                    ...
                    <a href="mailto:hello@sancodevs.com" style={{
